"""Generate `figures/22_sweep_gap_parallel_peak_transfer.png` - `plot_gap_to_peak_transfer_parallel_coupler`.
...
from WaveguideModalBPM1D import (
    WaveguideModalBPM1D,
...
def main() -> None:
    ...
    fig, _ = plot_gap_to_peak_transfer_parallel_coupler(
        sweep,
        current_gap=PARALLEL_GAP_PLOT_CURRENT_GAP,
        ax=PARALLEL_GAP_PEAK_AX,
    )
    save_figure(fig, "22_sweep_gap_parallel_peak_transfer.png")
