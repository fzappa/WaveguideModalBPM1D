"""Generate `figures/21_sweep_gap_parallel_lc_curve.png` - `plot_gap_to_lc_curve_parallel_coupler`.
...
def main() -> None:
    ...
    fig, _ = plot_gap_to_lc_curve_parallel_coupler(
        sweep,
        current_gap=PARALLEL_GAP_PLOT_CURRENT_GAP,
        current_lc=PARALLEL_GAP_PLOT_CURRENT_LC,
        ax=PARALLEL_GAP_CURVE_AX,
    )
    save_figure(fig, "21_sweep_gap_parallel_lc_curve.png")
