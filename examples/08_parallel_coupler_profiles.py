"""Generate `figures/08_parallel_coupler_profiles.png` - `plot_parallel_coupler_profiles`.
...
from WaveguideModalBPM1D import WaveguideModalBPM1D, plot_parallel_coupler_profiles, run_parallel_coupler_bpm
...
def main() -> None:
    ...
    fig, _ = plot_parallel_coupler_profiles(t3, xlim_factor=PARALLEL_PLOT_XLIM_FACTOR)
    save_figure(fig, "08_parallel_coupler_profiles.png")
